...
const PSS_DEFAULTS = [
  ...
  { code: "P4", product_type: "group_package", name: "Class Photo · 12×16 Framed", price: 950, print_size: "12×16", quantity: 1, framed: true, description: "Large official class/group photo with frame + white mat" },
  ...
  { code: "S3", product_type: "solo_addon", name: "Solo 8R Print", price: 150, print_size: "8R", quantity: 1, framed: false, description: "Optional 8R solo portrait print" },
  { code: "S4", product_type: "solo_addon", name: "Solo 8R + Frame", price: 550, print_size: "8R", quantity: 1, framed: true, description: "Optional 8R solo portrait with frame + white mat" },
  { code: "S5", product_type: "solo_addon", name: "Solo 12×16 + Frame", price: 950, print_size: "12×16", quantity: 1, framed: true, description: "Optional large solo portrait with frame + white mat" },
] as const;
